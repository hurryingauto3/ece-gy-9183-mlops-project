...
#             logger.debug(f"Listing contents of download directory: {output_dir}")
#             try:
#                 downloaded_items = os.listdir(output_dir)
#                 logger.debug(f"Contents: {downloaded_items}")
#                 logger.debug(f"Number of items found: {len(downloaded_items)}")
...
def parse_args():
    ...
    p.add_argument("folder_id", help="Google Drive root folder ID (from the URL)")
